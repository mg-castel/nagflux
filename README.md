[![GoDoc](https://godoc.org/github.com/mg-castel/nagflux?status.svg)](https://godoc.org/github.com/mg-castel/nagflux)
...
Nagflux collects data from the NagiosSpoolfileFolder and adds informations from Livestatus. This data is sent to an InfluxDB, to get displayed by Grafana. Therefor is the tool [Histou](https://github.com/mg-castel/histou) gives you the possibility to add Templates to Grafana.
...
## Install
```
go get -u github.com/mg-castel/nagflux
go build github.com/mg-castel/nagflux
```
A x86-64 Linux binary will be added to the releases. Here the link to the latest [Release](https://github.com/mg-castel/nagflux/releases/latest).
...
- If the logs are showing files are being read (in DEBUG mode) but nothing is going into InfluxDB, check the perfdata template to ensure it matches OMD format. See [Perfdata Template](https://github.com/mg-castel/nagflux#perfdata-template) for more details.
...
## DEMO
This Dockercontainer contains OMD and everything is preconfigured to use Nagflux/Histou/Grafana/InfluxDB: https://github.com/mg-castel/docker-omd-grafana
